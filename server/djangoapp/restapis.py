...
def get_dealer_reviews_from_cf(url, **kwargs):
    ...
    if json_result:
        ...
        for each_review in reviews:
            ...
            review_obj = DealerReview(dealership=each_review["dealership"],
                                   ...
                                   car_year=each_review["car_year"],
                                   sentiment=analyze_review_sentiments(each_review["review"]))
...
def analyze_review_sentiments(text):
    url = "https://api.eu-gb.natural-language-understanding.watson.cloud.ibm.com/instances/7e58eb21-c3ae-4577-b30b-805a8aba6ccd"
    api_key = "hGYYGnQeXbIS4ZZqvOEG6Hxq4QLoWEI_Tw_7BXYrNmsI"
